...
export default async function ProfilePage() {
  ...
  if (!user) {
    return (
      <div className="flex-1 w-full flex flex-col items-center justify-center gap-4 bg-zinc-900 pt-20">
  ...
  return (
    <div className="flex-1 w-full flex flex-col items-center justify-center gap-6 bg-zinc-900 pt-20">
